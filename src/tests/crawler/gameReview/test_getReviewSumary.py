...
class TestGetReviewSumary(unittest.TestCase):
    @classmethod
    def setUpClass(self) -> None:
        self.crawler = Crawler()
        self.soup    = self.crawler.reqUrl("https://store.steampowered.com/app/391540/Undertale/")

    def test_getReviewSumary(self):
        """ Verifica se o método getReviewSumary() está funcionando 
        corretamente.

        """

        sumary = getReviewSumary(self.soup)
